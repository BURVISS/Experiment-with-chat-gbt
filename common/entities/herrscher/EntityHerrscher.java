...
implements IEntityAdditionalSpawnData {
    ...
    private static final DataParameter<Integer> INVUL_TIME = EntityDataManager.func_187226_a(EntityHerrscher.class, (IDataSerializer)DataSerializers.field_187192_b);
    private static final DataParameter<Integer> STAGE = EntityDataManager.func_187226_a(EntityHerrscher.class, (IDataSerializer)DataSerializers.field_187192_b);
    ...
    protected void func_184651_r() {
        ...
        this.field_70714_bg.func_75776_a(1, (Goal)new LookAtGoal((MobEntity)this, PlayerEntity.class, 22.5f));
    }
    ...
    public boolean func_70097_a(@Nonnull DamageSource source, float amount) {
        ...
        if (e instanceof PlayerEntity && EntityHerrscher.isTruePlayer(e) && this.getInvulTime() == 0) {
    ...
    public List<PlayerEntity> getPlayersAround() {
        return this.field_70170_p.func_175647_a(PlayerEntity.class, EntityHerrscher.getArenaBB(this.source), player -> EntityHerrscher.isTruePlayer((Entity)player) && !player.func_175149_v());
    }

    private static int countHerrscherAround(World world, BlockPos source) {
        List l = world.func_217357_a(EntityHerrscher.class, EntityHerrscher.getArenaBB(source));
        return l.size();
    }
    ...
    private void keepInsideArena(PlayerEntity player) {
        if (MathHelper.pointDistanceSpace((double)player.func_226277_ct_(), (double)player.func_226278_cu_(), (double)player.func_226281_cx_(), (double)((double)this.source.func_177958_n() + 0.5), (double)((double)this.source.func_177956_o() + 0.5), (double)((double)this.source.func_177952_p() + 0.5)) >= 15.0f) {
    ...
    private void particles() {
        ...
        for (int i = 0; i < 360; i += 8) {
            ...
            double x = (double)this.source.func_177958_n() + 0.5 - Math.cos(rad) * 15.0;
            double y = (double)this.source.func_177956_o() + 0.5;
            double z = (double)this.source.func_177952_p() + 0.5 - Math.sin(rad) * 15.0;
    ...
    public static boolean checkInventory(PlayerEntity player) {
        ...
        for (int i = 0; i < player.field_71071_by.func_70297_j_(); ++i) {
            ...
            if (EntityHerrscher.checkFeasibility(stack)) continue;
            return false;
        }
        return true;
    }
