...
public class ItemPowerGlove
extends ItemBauble {
    public ItemPowerGlove(Item.Properties props) {
        super(props);
    }

    public Multimap<Attribute, AttributeModifier> getEquippedAttributeModifiers(ItemStack stack) {
        HashMultimap attributes = HashMultimap.create();
        attributes.put((Object)Attributes.field_233825_h_, (Object)new AttributeModifier(ItemPowerGlove.getBaubleUUID((ItemStack)stack), "Power Glove", (double)0.12f, AttributeModifier.Operation.MULTIPLY_TOTAL));
        return attributes;
    }
