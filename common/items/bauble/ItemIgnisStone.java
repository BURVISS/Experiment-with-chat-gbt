...
public class ItemIgnisStone
extends ItemBauble {
    public ItemIgnisStone(Item.Properties props) {
        super(props);
    }

    public Multimap<Attribute, AttributeModifier> getEquippedAttributeModifiers(ItemStack stack) {
        HashMultimap attributes = HashMultimap.create();
        attributes.put((Object)Attributes.field_233823_f_, (Object)new AttributeModifier(ItemIgnisStone.getBaubleUUID((ItemStack)stack), "Ignis Stone", (double)0.1f, AttributeModifier.Operation.MULTIPLY_TOTAL));
        return attributes;
    }
