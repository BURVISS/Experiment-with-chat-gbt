...
extends Item {
    ...
    public ActionResult<ItemStack> func_77659_a(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        BlockRayTraceResult raytraceresult = ItemCosmicCarKey.func_219968_a((World)worldIn, (PlayerEntity)playerIn, (RayTraceContext.FluidMode)RayTraceContext.FluidMode.ANY);
        ...
        if (raytraceresult.func_216346_c() == RayTraceResult.Type.BLOCK) {
            EntityUfo boatentity = new EntityUfo(worldIn, raytraceresult.func_216347_e().field_72450_a, raytraceresult.func_216347_e().field_72448_b, raytraceresult.func_216347_e().field_72449_c);
