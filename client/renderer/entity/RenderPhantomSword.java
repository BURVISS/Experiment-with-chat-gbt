...
public class RenderPhantomSword
extends EntityRenderer<EntityPhantomSword> {
    ...
    public void render(EntityPhantomSword weapon, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        float alpha = weapon.getFake() ? Math.max(0.0f, 0.75f - (float)weapon.field_70173_aa * 0.025f * 1.5f) : 1.0f;
