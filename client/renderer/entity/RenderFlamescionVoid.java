...
public class RenderFlamescionVoid
extends EntityRenderer<EntityFlamescionVoid> {
    ...
    public void render(EntityFlamescionVoid entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int packedLightIn) {
        ...
        matrixStackIn.func_227863_a_(Vector3f.field_229182_e_.func_229187_a_((float)ClientTickHandler.ticksInGame * 10.0f));
        float f1 = 0.083333336f;
        ...
        mc.field_71466_p.func_243247_a((ITextComponent)text.func_240699_a_(TextFormatting.GOLD), (float)(-halfWidth), 0.0f, -1, false, matrixStackIn.func_227866_c_().func_227870_a_(), bufferIn, false, 0, packedLightIn);
