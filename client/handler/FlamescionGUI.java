...
extends AbstractGui {
    ...
    private final ResourceLocation HUD = new ResourceLocation("extrabotany", "textures/gui/flamescionhud.png");
    ...
    public void render() {
        ...
        LazyOptional cap = this.minecraft.field_71439_g.getCapability(CapabilityHandler.FLAMESCION_CAPABILITY);
        cap.ifPresent(c -> {
            int energy = c.getEnergy();
            boolean overloaded = c.isOverloaded();
            this.renderBar(energy, overloaded);
        });
    }
    ...
    private void renderBar(int energy, boolean overloaded) {
        ...
        if (!overloaded) {
            ...
            this.func_238474_b_(this.ms, x, y, 0, 12, width, 6);
        }
